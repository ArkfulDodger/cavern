...
//     [MenuItem ("Custom/Sprite Swapper")]
//     static void Init () {
//         // Get existing open window or if none, make a new one:      
//         EditorWindow.GetWindow(typeof(SpriteSwapper));
//     }
...
//                     keyframes[i].value = sprites.Where(x => x.name.Contains("_"+splitName[1])).FirstOrDefault();
//                 }
